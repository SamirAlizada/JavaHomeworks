...
public class GameManager implements GameService{
	...
	public void add(Game game) {
		System.out.println(game.getGameName()+" isimli oyun sisteme eklendi. Oyunun indirimsiz fiyatý "+game.getPrice()+" TL olarak belirlendi. Oyunun stokdaki adedi : "+game.getStockAmount());
	}
	@Override
